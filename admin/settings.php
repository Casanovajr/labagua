    ...
    <div id="wrapper">
        ...
        <div class="navbar-default sidebar" role="navigation">
            ...
            <button class="btn btn-default" type="button"> <i class="fa fa-search"></i> </button>
                    ...
                    <li class="user-pro">
                        <a href="#" class="waves-effect active"><img src="../plugins/images/user.jpg" alt="user-img" class="img-circle"> <span class="hide-menu"> Conta<span class="fa arrow"></span></span>
                        </a>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="white-box">
                            <h3 class="box-title m-b-0">Mude a configuração da sua conta</h3>
                            <p class="text-muted m-b-30 font-13"> (Atualize sua senha) </p>
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                    <form action="functions/settings.php" method="post">
                                      ...
                                      <!--   <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputpwd1">Nova Senha</label>
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="ti-lock"></i></div>
                                                <input type="password" name="password" id="Password" class="form-control" id="exampleInputpwd1" placeholder="Digita sua Senha" required=""> </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <button type="submit" name="submit" class="btn btn-success waves-effect waves-light m-r-10">Trocar senha</button>
                                    </form>
                                </div>
                            </div>
                        </div>
                ...
                $(document).ready(function(){
                    $("#ConfirmPassword").keyup(function(){
                         if ($("#Password").val() != $("#ConfirmPassword").val()) {
                             $("#msg").html("As senhas não conferem").css("color","red");
                         }else{
                             $("#msg").html("As senhas conferem").css("color","green");
                        }
                  });
            });
            </script> 

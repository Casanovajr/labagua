        ...
        <ul class="nav navbar-top-links navbar-left hidden-xs">
          ...
          <li>
            <form role="search" class="app-search hidden-xs">
              <input type="text" placeholder="Pesquisar..." class="form-control"> <a href=""><i class="fa fa-search"></i></a>
            </form>
          </li>
        </ul>
        ...
        <div class="row">
          ...
          <div class="col-sm-12">
            <div class="white-box">
              ...
              <h3 class="box-title m-b-0">LabÁgua Membros da Equipe ( <x style="color: orange;"><?php echo mysqli_num_rows($result); ?></x> )</h3>
              <p class="text-muted m-b-30">Exporte os dados para Copia, CSV, Excel, PDF & Impressão</p>
              <div class="table-responsive">
                <table id="example23" class="display nowrap" cellspacing="0" width="100%">
                  <?php
                  if (mysqli_num_rows($result) == 0) {
                    echo "<i style='color:brown;'>Sem membros pendentes aqui :( </i> ";
                  } else {
                    echo '
                    <thead>
                      <tr>                                                       
                  ...
                  while ($row = $result->fetch_assoc()) {
                    ...
                    <tr>
                      ...
                      <td><img style="width: 50px; height: 50px;" src="data:image/jpeg;base64,' . base64_encode($row['foto']) . '" alt="' . $row['nome'] . '"></td>
                      <td>

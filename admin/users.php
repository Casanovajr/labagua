                ...
                <div class="row bg-title">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12"> 
                        <ol class="breadcrumb">
                            ...
                            <li class="active"> <a href="new-user.php" class="btn btn-success btn-rounded btn-outline hidden-xs hidden-sm waves-effect waves-light">Criar Novo Administradores</a></li>
                        </ol>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                        		...
                        		<?php
									if (isset($_GET["success"])) {
										...
										'<div class="alert alert-success" >
					                         ...
					                         <strong>DONE!! </strong><p> O novo Administrador foi adicionado. Eles agora pode fazer login em sua conta com suas credenciais.</p>
					                    </div>'
										;
									}
                                    elseif (isset($_GET["deleted"])) {
                                        ...
                                        '<div class="alert alert-warning" >
                                              <a href="#" class="close" data-dismiss="alert" aria-label="close"></a>
                                             <strong>DELETED!! </strong><p> O Administrador foi removido com sucesso.</p>
                                        </div>'
                                        ;
                                    }
                                    elseif (isset($_GET["del_error"])) {
                                        ...
                                        '<div class="alert alert-danger" >
                                              <a href="#" class="close" data-dismiss="alert" aria-label="close"></a>
                                             <strong>ERROR!! </strong><p> Ocorreu um erro ao tentar remover os registros. Tente novamente.</p>
                                        </div>'
                                        ;
                                    }
								?>	

                            <h3 class="box-title m-b-0">LabÁgua Administradores ( <x style="color: orange;"><?php echo mysqli_num_rows($query);?></x> )</h3>
                            <p class="text-muted m-b-30">Exporte os dados para Copia, CSV, Excel, PDF & Impressão</p>
                            <div class="table-responsive">
                                <table id="example23" class="display nowrap" cellspacing="0" width="100%">
                                    ...
                                    if (mysqli_num_rows($query)==0) {
                                                    echo "<i style='color:brown;'>Sem administradores aqui :( </i> ";
                                                }
                                                else{
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            ...
                                                            <h4 class="modal-title">Você tem certeza que quer deletar um administrador?</h4></div>
